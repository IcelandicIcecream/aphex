import { i as head, g as attr } from './index5-DltsKoco.js';
          ...
          Card_header($$renderer4, {
            ...
            children: ($$renderer5) => {
              ...
              Card_title($$renderer5, {
                ...
                children: ($$renderer6) => {
                  $$renderer6.push(`<!---->${escape_html(mode === "reset-password" ? "Reset Password" : mode === "signin" ? "Sign In" : "Create Account")}`);
                },
                $$slots: { default: true }
              });
              $$renderer5.push(`<!----> <!---->`);
              Card_description($$renderer5, {
                class: "text-center",
                children: ($$renderer6) => {
                  $$renderer6.push(`<!---->${escape_html(mode === "reset-password" ? "Enter your email to receive a reset link" : mode === "signin" ? "Access your CMS dashboard" : "Get started with Aphex CMS")}`);
                },
                $$slots: { default: true }
              });
              $$renderer5.push(`<!---->`);
            ...
            children: ($$renderer5) => {
              {
                ...
                if (resetSuccess) {
                  $$renderer5.push("<!--[-->");
                  $$renderer5.push(`<div class="rounded-lg border border-green-500/50 bg-green-500/10 p-3"><p class="text-sm font-medium text-green-700 dark:text-green-400">${escape_html(resetSuccess)}</p></div>`);
                } else {
                  $$renderer5.push("<!--[!-->");
                }
                $$renderer5.push(`<!--]--> `);
                ...
                Button($$renderer5, {
                  ...
                  children: ($$renderer6) => {
                    ...
                    $$renderer6.push(`<!--]-->${escape_html(mode === "reset-password" ? "Send Reset Link" : mode === "signin" ? "Sign In" : "Sign Up")}`);
                  },
                  $$slots: { default: true }
                });
                $$renderer5.push(`<!----> `);
...
//# sourceMappingURL=_page.svelte-C0nWv3vC.js.map
