import { d as derived, a as attributes, c as clsx, f as ensure_array_like, e as element, b as bind_props, s as spread_props, p as props_id, l as lifecycle_function_unavailable, g as attr } from './index5-DltsKoco.js';
import { c as cn } from './utils2-CVx6kO_W.js';
import { t as tv } from './button-1bYQaKO-.js';
import { d as dayjs, u as utc } from './date-utils-xyIWAIQq.js';
import { b as boxWith, s as simpleBox, c as createBitsAttrs, i as isWritableSymbol, B as BoxSymbol, a as boxFrom, d as boxFlatten, t as toReadonlyBox, e as isBox, f as isWritableBox, g as createId, m as mergeProps, h as attachRef, j as isObject, k as getDataOpenClosed, l as boolToStr, n as boolToEmptyStrOrUndef, o as cssToStyleObj, p as styleToString, q as executeCallbacks, r as composeHandlers } from './create-id-BLMzD-FL.js';
import { M as MediaQuery, S as SvelteMap, c as createSubscriber } from './states.svelte-CxCkWsnb.js';
import { s as setContext, h as hasContext, g as getContext, a as getAllContexts, e as escape_html } from './context-CAhUmS6w.js';
...
function isResponsibleEscapeLayer(instance2) {
  const layersArr = [...globalThis.bitsEscapeLayers];
  const topMostLayer = layersArr.findLast(([_, { current: behaviorType }]) => behaviorType === "close" || behaviorType === "ignore");
  if (topMostLayer) return topMostLayer[0] === instance2;
  const [firstLayerNode] = layersArr[0];
  return firstLayerNode === instance2;
}
...
function isHighestLayer(instance2) {
  const layersArr = [...globalThis.bitsTextSelectionLayers];
  if (!layersArr.length) return false;
  const highestLayer = layersArr.at(-1);
  if (!highestLayer) return false;
  return highestLayer[0] === instance2;
}
...
export { Tooltip_content as $, SPACE as A, watch as B, Context as C, DropdownMenuTriggerState as D, ENTER as E, Floating_layer as F, afterTick as G, Alert as H, Icon as I, documents as J, ApiError as K, assets as L, MenuRootState as M, isHTMLElement$1 as N, Dialog_content as O, Provider as P, Dialog_close as Q, RovingFocusGroup as R, SIDEBAR_COOKIE_NAME as S, Dialog_overlay as T, DialogTriggerState as U, organizations as V, DOMContext as W, X, user as Y, Root as Z, Tooltip_trigger as _, currentDateTime as a, apiKeys as a0, DOMTypeahead as a1, ARROW_UP as a2, ARROW_DOWN as a3, TAB as a4, PAGE_UP as a5, HOME as a6, PAGE_DOWN as a7, END as a8, next as a9, prev as aa, forward as ab, backward as ac, boxAutoReset as ad, getNextMatch as ae, afterSleep as af, isIOS as ag, instance as ah, invitations as ai, SIDEBAR_COOKIE_MAX_AGE as b, currentDate as c, dateFromToday as d, SIDEBAR_WIDTH as e, firstDayOfMonth as f, SIDEBAR_WIDTH_ICON as g, Sheet_content as h, SIDEBAR_WIDTH_MOBILE as i, Sidebar_menu_button as j, MenuMenuState as k, Portal as l, Floating_layer_anchor as m, noop as n, MenuContentState as o, Popper_layer_force_mount as p, Popper_layer as q, getFloatingContentCSSVars as r, setSidebar as s, MenuSeparatorState as t, useSidebar as u, MenuItemState as v, DialogRootState as w, DialogTitleState as x, DialogDescriptionState as y, PresenceManager as z };
//# sourceMappingURL=sheet-content-CfdNXqIw.js.map
