...
export interface SiteSettings {
	...
	favicon?: ImageValue;
	/**
	 * A list of brand colors — each row is a color picker.
	 */
	brandColors?: string[];
	/**
...
export interface Theme {
	...
	fontBody?: string;
	/**
	 * Base reading size. Everything else scales from this.
	 */
	baseSize?: number;
	...
	contentWidth?: number;
	/**
	 * Roundness of cards, images, and buttons.
	 */
	radius?: number;
	/** Document metadata */
	_meta?: {
...
declare module '@aphexcms/cms-core/server' {
	interface Collections {
		...
		theme: SingletonCollection<Theme>;
	}
}
