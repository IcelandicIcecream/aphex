...
When both are present, `capabilities` wins — the key can do exactly what's listed and nothing else. See [API Keys](/docs/api-keys#capabilities) for the full reference.
