...
- [#319](https://github.com/IcelandicIcecream/aphex/pull/319) [`5738118`](https://github.com/IcelandicIcecream/aphex/commit/57381180d0804797c952d87f6062bc11fe9b3e0b) Thanks [@IcelandicIcecream](https://github.com/IcelandicIcecream)! - fix: a `perspective` set on the Local API context now reaches the adapter
...
- [#317](https://github.com/IcelandicIcecream/aphex/pull/317) [`ab9ce36`](https://github.com/IcelandicIcecream/aphex/commit/ab9ce3692d25a9a2f6823a969dc154be79103840) Thanks [@IcelandicIcecream](https://github.com/IcelandicIcecream)! - Describe the HTTP API from the instance itself: `GET /api/openapi.json` and a rendered
