...
export class DocumentsApi {
   ...
   */
  static async getByType(docType: string, params: Omit<DocumentListParams, 'docType'> = {}): Promise<ApiResponse<Document[]>> {
   ...
   */
  static async getPublished(params: Omit<DocumentListParams, 'status'> = {}): Promise<ApiResponse<Document[]>> {
   ...
   */
  static async getDrafts(params: Omit<DocumentListParams, 'status'> = {}): Promise<ApiResponse<Document[]>> {
