...
[![Deploy with Vercel](https://vercel.com/button)](https://vercel.com/new/clone?repository-url=https%3A%2F%2Fgithub.com%2FIcelandicIcecream%2Faphex-base&project-name=my-aphex-app&repository-name=my-aphex-app&demo-title=AphexCMS&demo-description=A%20clean%20starting%20point%20for%20building%20with%20Aphex%20CMS&env=BETTER_AUTH_SECRET&envDescription=Random%20secret%20Better%20Auth%20uses%20to%20sign%20session%20tokens.%20Generate%20one%20with%3A%20openssl%20rand%20-base64%2032&envLink=https%3A%2F%2Fgithub.com%2FIcelandicIcecream%2Faphex-base%2Fblob%2Fmain%2F.env.example&products=%5B%7B%22type%22%3A%22integration%22%2C%22integrationSlug%22%3A%22neon%22%2C%22productSlug%22%3A%22neon%22%2C%22protocol%22%3A%22storage%22%7D%5D&stores=%5B%7B%22type%22%3A%22blob%22%2C%22access%22%3A%22public%22%7D%5D)

You'll be asked for one value, `BETTER_AUTH_SECRET` — any long random string (`openssl rand -base64 32` works). Once it's live, visit `/admin` on your new deployment and sign up — the first account becomes super admin. This deploys from the standalone [**aphex-base**](https://github.com/IcelandicIcecream/aphex-base) mirror — a real, self-contained repo rather than a `root-directory` slice of this monorepo. It's an isolated instance per click, not a shared demo, and is meant for trying the product, not production use.
